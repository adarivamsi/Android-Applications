...
public class SampleCamActivity extends AbstractArchitectCamActivity {
    ...
    protected void saveScreenCaptureToExternalStorage(Bitmap screenCapture) {
        if ( screenCapture != null ) {
            ...
            File Dir = new File(Environment.getExternalStorageDirectory().toString() + File.separator + "AReality Screenshots" + File.separator);
            Dir.mkdirs();
            ...
            try {
                ...
                SampleCamActivity.this.runOnUiThread(() -> {
                    ...
                    Toast.makeText(SampleCamActivity.this, "Screenshot saved in Gallery", Toast.LENGTH_LONG).show();
                });
            }
        }
    }
