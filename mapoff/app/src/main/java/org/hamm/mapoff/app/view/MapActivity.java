package org.hamm.mapoff.app.view;
...
import org.hamm.mapoff.app.R;
import org.hamm.mapoff.app.application.MapoffApplication;
import org.hamm.mapoff.app.model.NavigationDrawerItem;
import org.hamm.mapoff.app.util.NavigationDrawerListAdapter;
import org.hamm.mapoff.app.util.Utils;
import java.util.*;
...
public class MapActivity extends ActionBarActivity implements SKMapSurfaceListener, SKRouteListener, SKNavigationListener,
    ...
    /**
     * TheMapoffApplication is for saving the overall state of the app
     */
    private MapoffApplication mApp;
     ...
     *
     * First an application object is retrieved via mApp = (MapoffApplication) getApplication();.
     * Is that done, the previous app state is loaded from the json file (see classMapoffApplication
     * for more detail).
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mApp = (MapoffApplication) getApplication();
